      ...
      <nav className="mx-auto flex h-20 lg:h-24 w-full items-center gap-8 px-6 lg:px-8 lg:max-w-7xl">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Link 
            ...
            className="group flex items-center gap-2 px-4 py-2 rounded-xl border border-border/30 hover:border-primary/40 transition-all duration-300 text-sm font-light hover:bg-muted/10"
          >
            <svg
          ...
          <Link 
            href="#" 
            className="px-5 py-2 text-sm font-light border border-border/30 rounded-xl hover:border-primary/50 transition-all duration-300 hover:bg-muted/10"
          >
            Entrar
          </Link>
          ...
          <Link 
            href="#" 
            className="px-5 py-2 text-sm font-normal bg-foreground text-background rounded-xl hover:bg-foreground/90 transition-all duration-300 hover:scale-[1.02]"
          >
            Começar
          </Link>
        </div>
              ...
              <div className="px-8 pb-8 space-y-8">
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    <span className="text-sm font-light">Discord</span>
                  </Link>
                </div>
                ...
                <div className="flex gap-4 max-w-sm mx-auto">
                  <SheetClose asChild>
                    <Link 
                      href="#" 
                      className="flex-1 text-center py-4 px-6 rounded-2xl border border-border/30 hover:border-primary/50 transition-all duration-300 text-sm font-light hover:bg-muted/10"
                    >
                      Entrar
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link 
                      href="#" 
                      className="flex-1 text-center py-4 px-6 rounded-2xl bg-foreground text-background hover:bg-foreground/90 transition-all duration-300 text-sm font-normal hover:scale-[1.02]"
                    >
                      Começar
                    </Link>
                  </SheetClose>
