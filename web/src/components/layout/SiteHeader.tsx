        ...
        <div className="hidden lg:flex items-center gap-12">
          {navItems.map((item) => (
            <Link 
              key={item.title} 
              href={item.href}
              className="group relative py-2 text-base font-medium tracking-wide text-foreground/80 hover:text-primary transition-all duration-300 ease-out"
            >
                  ...
                  {navItems.map((item, index) => (
                    <div key={item.title} className="overflow-hidden">
                      <SheetClose asChild>
                        ...
                        >
                          <div className="text-4xl md:text-5xl font-medium tracking-tight text-foreground group-hover:text-primary transition-colors duration-300">
                            {item.title}
                          </div>
