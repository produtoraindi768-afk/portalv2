...
interface TypographyProps {
   ...
   * - h3: xl/tight font-medium - Subsection headings
 * - h4: lg font-medium - Component headings
 * - h5: base font-medium - Small headings
 * - h6: sm font-medium - Smallest headings
 * - hero: 4xl/tight font-normal - Special hero titles (elegant impact)
 * - body-lg: lg font-normal - Large body text
 * - body: base font-normal - Standard body text (default)
 * - body-sm: sm font-normal - Small body text
 * - caption: xs font-normal - Caption/helper text
 * - lead: lg font-normal text-muted-foreground - Lead paragraphs
 * - muted: base font-normal text-muted-foreground - Muted text
   */
  variant?: 
...
const variantStyles = {
  h1: "text-2xl/tight font-semibold tracking-tight sm:text-3xl/tight md:text-4xl/tight",
  h2: "text-xl/tight font-semibold tracking-tight sm:text-2xl/tight md:text-3xl/tight", 
  h3: "text-lg/tight font-medium tracking-tight sm:text-xl/tight md:text-2xl/tight",
  h4: "text-base font-medium tracking-tight sm:text-lg md:text-xl",
  ...
  hero: "text-3xl/tight font-normal tracking-tight sm:text-4xl/tight md:text-5xl/tight",
  "body-lg": "text-base leading-relaxed font-normal sm:text-lg",
  body: "text-sm leading-relaxed font-normal sm:text-base",
  "body-sm": "text-xs leading-relaxed font-normal sm:text-sm", 
  caption: "text-xs leading-normal text-muted-foreground font-normal",
  lead: "text-base leading-relaxed text-muted-foreground font-normal sm:text-lg md:text-xl/relaxed",
  muted: "text-sm leading-relaxed text-muted-foreground font-normal sm:text-base"
}
