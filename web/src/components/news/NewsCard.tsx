...
// Componente Skeleton para NewsCard
export function NewsCardSkeleton({ 
  ...
  if (variant === 'compact') {
    return (
      <div className={cn(
        "block p-4 rounded-lg border border-border/50",
  ...
  if (variant === 'featured') {
    return (
      <Card className={cn(
        ...
        <div className="grid grid-rows-subgrid row-span-3 h-full">
          {/* Featured header skeleton */}
          <div className="relative h-44 sm:h-48 md:h-52 flex-shrink-0">
          ...
          <div className="p-4 sm:p-5 md:p-6 flex flex-col min-h-[200px] sm:min-h-[220px] space-y-4">
            {/* Metadata skeleton */}
          ...
          {/* Footer skeleton */}
          <div className="p-4 sm:p-5 md:p-6 pt-2 flex-shrink-0">
            <div className="flex items-center justify-between pt-4 border-t border-border/20">
  ...
  return (
    <Card className={cn(
      ...
      <div className="grid grid-rows-subgrid row-span-3 h-full">
        ...
        {/* Content area skeleton */}
        <div className="p-3 sm:p-4 md:p-5 flex flex-col min-h-[160px] sm:min-h-[180px] space-y-3">
          {/* Metadata skeleton */}
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Skeleton className="w-4 h-4" />
        ...
        {/* Footer skeleton */}
        <div className="p-3 sm:p-4 md:p-5 pt-2 flex-shrink-0">
          <div className="flex items-center justify-between pt-3 border-t border-border/20">
            <Skeleton className="w-24 h-4" />
            <Skeleton className="w-12 h-3" />
          </div>
